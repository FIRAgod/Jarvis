...
python_files = ['recover_0.py','claw_apple3_firststep.py','claw_apple3_secondstep.py','set_hand_command.py','claw_apple3_firststep.py','claw_apple_thirdstep.py','release_hand1.py']
