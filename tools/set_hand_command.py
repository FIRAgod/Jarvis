...
def main():
    # 设置左手和右手的手指位置: 0 - 2000
    left_finger_positions = [1000, 1000, 1500,1500,1500,1500]
    right_finger_positions = [500,500,1000,1000, 1000, 1000]

    # 如果需要，可以传入手指扭矩（默认值为0）
    left_finger_torques = [3000, 3000, 3000, 3000, 3000, 3000]
    right_finger_torques = [700, 700, 800, 800, 800, 800]
