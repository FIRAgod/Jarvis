...
def main():
    # 设置左手和右手的手指位置: 0 - 2000
    left_finger_positions = [1500, 1500, 1300,1300,1300,1300]
    right_finger_positions = [100,100,100,100, 100, 100]

    # 如果需要，可以传入手指扭矩（默认值为0）
    left_finger_torques = [5500, 5500, 5500, 5500, 5500, 5500]
    right_finger_torques = [1000, 1000, 1000, 1000, 1000, 1000]
