...
def main():
    # 设置左手和右手的手指位置: 0 - 2000
    left_finger_positions = [750, 750, 750, 750, 750, 750]
    right_finger_positions = [100,100,700,700,700,700]

    # 如果需要，可以传入手指扭矩（默认值为0）
    left_finger_torques = [1500, 1500, 1500, 1500, 1500, 1500]
    right_finger_torques = [500, 500, 500, 500, 500, 500]
