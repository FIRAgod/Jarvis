...
if __name__ == '__main__':
    ...
    while True:
        ...
        if '天气' in result_sentence or 'weather' in result_sentence:
            set_mode("STAND_ARM_EXT_JOINT_TRAJ")
            subprocess.run(["bash", "/agibot/data/home/agi/jarvis/RC/a2_PlayerMotion.sh", '67'])
            set_mode("STAND_ARM_EXT_JOINT_SERVO")
            if '上海' in result_sentence or 'Shanghai' in result_sentence:
                get_weather('上海')
            ...
            elif '北京' in result_sentence or 'Beijing' in result_sentence:
                get_weather('北京')
                weather=read_txt_weather_file('/agibot/data/home/agi/jarvis/asr/weather.txt')
                synthesis_text_to_speech_and_play_by_streaming_mode("我将为您播报今天北京的天气情况："+weather)
            elif '香港' in result_sentence or 'Hongkong' in result_sentence:
                get_weather('香港')
                weather=read_txt_weather_file('/agibot/data/home/agi/jarvis/asr/weather.txt')
        ...
        elif '新闻' in result_sentence or 'News' in result_sentence or 'news' in result_sentence:
            set_mode("STAND_ARM_EXT_JOINT_TRAJ")
        ...
        elif '握手' in result_sentence or '握个手' in result_sentence or '握下手' in result_sentence or 'shake hands' in result_sentence or 'Shake hands' in result_sentence:
        ...
        elif '手指舞' in result_sentence or 'Finger Dance' in result_sentence or 'finger dance' in result_sentence:
        ...
        #     has_talk=1
        ...
        elif '关机' in result_sentence or 'Shut down' in result_sentence:
            run_python_script(
                    script_path="/agibot/data/home/agi/jarvis/action.py",
                    change_dir=True,
                    directory="/agibot/data/home/agi",
            ...
            time.sleep(0.2)
            if 'Shut down' in result_sentence:
                synthesis_text_to_speech_and_play_by_streaming_mode("OK, you can shut down now!")
            else:
        ...
        if '再见' in result_sentence or 'Goodbye' in result_sentence:
            is_talk=0
