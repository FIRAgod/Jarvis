...
def main():
    left_positions_list = [
    	[ 0.8946, 1.3544, 0.2,  -0.7877,  2.0,  -0.0004, 0.1525]
        ]
      # [ 0.4002, 1.2544, 0.22, -1.17,   2.35, -0.0004, 0.1525] step3
      # [ 0.1946, 0.9544, 0.3,  -1.5377, 1.3,  -0.0004, 0.0025] step2
      # [-0.1054, 0.7544, 0,    -0.7177, 1.5,  -0.0004, 0.0025] step1
      # [-0.1054, 1.2544, 0,    -0.7177, 1.5,  -0.0004, 0.0025] 零位
 ...
 # [ 0.8944, -1.3544, 0.2,  0.8377, 2.0,  0.0093,  0.1473] step4
 # [ 0.4,    -1.2544, 0.22, 1.22,   2.35, 0.0093,  0.1473] step3
 # [ 0.1944, -0.9544, 0.3,  1.5377, 1.3,  0.0093, -0.0027] step2
 # [-0.1056, -0.7544, 0,    0.7177, 1.5,  0.0093, -0.0027] step1
   [-0.1056, -1.2544, 0,    0.7177, 1.5,  0.0093, -0.0027] # 零位 
