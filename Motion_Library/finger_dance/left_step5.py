...
def main():
    left_positions_list = [
    	  [ 0.7055, 0.9544, -0.2, -1.4277, 0.9, -0.0004, 0.0025]  # 左臂step5
        ]
        # [ 0.7055, 0.7544, -0.8, -1.4277, 1.7, -0.0004, 0.0025]  # 左臂step4
        # [ 0.6055, 0.7544, -0.8, -1.9277, 1.7, -0.0004, 0.0025]  # 左臂step2
        # [-0.1055, 0.7544,  0,   -0.7177, 1.5, -0.0004, 0.0025]  # 左臂step1
    ...
    right_positions_list = [
        ...
        # [-0.1056, -0.7544,  0,   0.7177, 1.5, 0.0093, -0.0027]   step1
        # [ 0.6056, -0.7544, -0.8, 1.9277, 1.7, 0.0093,  0.0027] # step2
        # [ 0.7056, -0.7544, -0.8, 1.8277, 1.7, 0.1093,  0.1027] # step3
        # [ 0.7056, -0.7544, -0.8, 1.4277, 1.7, 0.1093,  0.1027] # step4
          [ 0.7056, -0.9544, -0.2, 1.4277, 0.9, 0.0093,  0.0027] # step5

        # [ 0.3056, -0.7544, -0.8, 1.8877, 1.7, 0.0093, -0.0027] # step2
        # [ 0.4056, -0.7544, -0.8, 1.7877, 1.7,-0.1093, -0.1027] # step3  
