...
def main():
    ...
    right_finger_positions = [100, 100, 1500, 1300, 1000, 750] # hand5_3
  # right_finger_positions = [100, 100, 650,  850,  1200, 1550] # hand5_2
  # right_finger_positions = [100, 100, 1200, 1200, 1200, 1200] # hand5_1

    # 如果需要，可以传入手指扭矩（默认值为0）
    left_finger_torques = [1000, 1000, 1000, 1000, 1000, 1000]
    right_finger_torques = [2000, 2000, 2000, 2000, 2000, 2000]
