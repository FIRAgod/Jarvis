...
def main():
    # 设置左手和右手的手指位置: 0 - 2000
    left_finger_positions =  [800, 800, 1200, 1200, 1200, 1200]
    right_finger_positions = [800, 800, 1200, 1200, 1200, 1200] # hand6_9
  # right_finger_positions = [900, 100, 1200, 1200, 1200, 1200] # hand6_8
  # right_finger_positions = [900, 100, 100, 1200, 1200, 1200] # hand6_7
  # right_finger_positions = [900, 100, 100, 100, 1200, 1200] # hand6_6
  # right_finger_positions = [900, 100, 100, 100, 100, 1200] # hand6_5
  # right_finger_positions = [900, 100, 100, 100, 1200, 100] # hand6_4
  # right_finger_positions = [900, 100, 100, 1200, 100, 100] # hand6_3
  # right_finger_positions = [900, 100, 1200, 100, 100, 100] # hand6_2
  # right_finger_positions = [1100, 1000, 100, 100, 100, 100] # hand6_1
