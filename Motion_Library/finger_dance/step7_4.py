...
def main():
    left_positions_list = [
    	  [-0.1055, 1.0544, -0.2, -1.4177, 1.2, -0.0004, 0.0025]  # 左臂step7_4
        ]
        # [-0.1055, 1.0544, -0.2, -1.5177, 1.2, -0.0004, 0.0025]  # 左臂step7_3
    ...
    right_positions_list = [
        ...
        # [-0.1056, -0.7544, -1.3, 1.3177, 1.5, 0.0093, -0.0027] # step7_1
        # [-0.1056, -0.7544, -1.3, 1.2177, 1.5, 0.0093, -0.0027] # step7_2
        # [-0.1056, -1.0544, -0.2, 1.6177, 1.2, 0.0093, -0.0027] # step7_3
          [-0.1056, -1.0544, -0.2, 1.5177, 1.2, 0.0093, -0.0027] # step7_4
