...
def main():
    left_positions_list = [
        ...
        [-0.1055,1.2544,0,-0.7177,1.5,-0.0004,0.0025],
        [-0.1055,1.2544,0,-0.7177,1.5,-0.0004,0.0025],
        ]

    right_positions_list = [
        [-0.1056, -1.2544, 0, 0.7177, 1.5, 0.0093, -0.0027],  # 右臂零位
        [-0.1056, -0.7544, 0, 0.7177, 1.5, 0.0093, -0.0027],
        [ 0.3056, -0.7544, -0.8, 1.9277, 1.7, 0.0093,  0.1027],
        [ 0.4056, -0.7544, -0.8, 1.7877, 1.7,-0.1093, -0.1027],
        [ 0.3056, -0.7544, -0.8, 1.9277, 1.7, 0.0093,  0.1027],
        [ 0.4056, -0.7544, -0.8, 1.7877, 1.7,-0.1093, -0.1027],
        [ 0.3056, -0.7544, -0.8, 1.9277, 1.7, 0.0093,  0.1027],
        [ 0.4056, -0.7544, -0.8, 1.7877, 1.7,-0.1093, -0.1027],
        ...
        [ 0.4056, -0.7544, -0.8, 1.7877, 1.7,-0.1093, -0.1027],
        [-0.1056, -0.7544, 0, 0.7177, 1.5, 0.0093, -0.0027],
        [-0.1056, -1.2544, 0, 0.7177, 1.5, 0.0093, -0.0027],
